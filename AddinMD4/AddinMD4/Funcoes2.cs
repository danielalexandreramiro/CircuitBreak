...
namespace AddinMD4
{
    public class Funcoes2
    {
        ...
        public string UsoCircuitBreakAntes()
        {
            ...
            while (inicio < 10)
            {
                return new Funcoes2().UsoCircuitBreak();
                inicio++;
            }
            return "fim";
        }
        ...
        public string UsoCircuitBreak()
        {
            ...
            Task<bool> task = retry.ExecuteAsync(() =>
            {
                ...
                execRety++;
                if (usuario.ValorAtual == 1) { resposta = "Ret-usuario.ValorAtual=1"; ifRetry++; return false; }
                else { resposta = "Ret-usuario.ValorAtual!=1"; elseRetry++; return true; } //tenta fazer a conexão com o
            });
